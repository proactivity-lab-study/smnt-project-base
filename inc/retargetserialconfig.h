...
//  #define RETARGET_TX_LOCATION _USART_ROUTELOC0_TXLOC_LOC5  /* Location of of USART TX pin */
  #define RETARGET_TX_LOCATION _USART_ROUTELOC0_TXLOC_LOC25  /* Location of of USART TX pin */ //--rerout to programming header
  #define RETARGET_RX_LOCATION _USART_ROUTELOC0_RXLOC_LOC3  /* Location of of USART RX pin */
//  #define RETARGET_TXPORT      gpioPortA                    /* UART transmission port */
//  #define RETARGET_TXPIN       5                            /* UART transmission pin */
  #define RETARGET_TXPORT      gpioPortF                    /* UART transmission port */ //--rerout to programming header
  #define RETARGET_TXPIN       1                            /* UART transmission pin */ //--rerout to programming header
  #define RETARGET_RXPORT      gpioPortA                    /* UART reception port */
  #define RETARGET_RXPIN       4                             /* UART reception pin */
  ...
  #define RETARGET_CTSPIN       13
  #define RETARGET_RTSPORT      gpioPortB
  #define RETARGET_RTSPIN       14
